        ...
        FS.registerDevice(dev, TTY.stream_ops);
          ...
          if (!tty.input.length) {
            ...
            if (typeof window != 'undefined' &&
              ...
              // Browser.
              result = window.prompt('Provide a string of 81 numbers, form left to right, downard (0 MUST REPRESENT BLANKS).\n\nHit the `Ok` button, then on the second pop-up, click `Cancel` (weird bug) Use Console to view the puzzle deduction live (F12).');  // returns null on cancel
              if (result !== null) {
                result += '\n';
              }
